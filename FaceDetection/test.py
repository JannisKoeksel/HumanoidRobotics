...
jannis_image = np.array(jannis_image)
print( type( jannis_image ), jannis_image.shape, jannis_image.dtype)
...
while True:
    ...
    if process_this_frame:
        ...
        rgb_tiny_frame = np.ascontiguousarray(rgb_small_frame[::2,::2])
        ...
        if(len(face_locations) == 0):
            continue
        l,t,r,b = face_locations[0]
        
        face_encodings = face_recognition.face_encodings(rgb_tiny_frame, [(int(l/2), int(t/2), int(r/2),int(b/2))], model="small")
        print(face_encodings)
        # print("after face_encodings")
