...
frameHeight = 480 #Resolution of camera
frameWidth = 640
#Used for cutting out smaller images of the face and sending them to recognition
facePadding = 20 
...
def face_detection(queue, terminate):
    ...
    #Extracting results
    results = model(img)
    #Following part will use gpu and will be fast
    while (True):
